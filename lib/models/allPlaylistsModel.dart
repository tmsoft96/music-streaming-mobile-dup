...
class AllPlaylistsModel {
  bool? ok;
  String? msg;
  int? count;
  List<AllPlaylistsData>? data;

  AllPlaylistsModel({this.ok, this.msg, this.count, this.data});

  AllPlaylistsModel.fromJson({
    ...
    if (json != null) {
      ...
      if (json['data'] != null) {
        ...
        json['data'].forEach((v) {
          data!.add(new AllPlaylistsData.fromJson(v));
        });
      }
    } else {
      ok = false;
...
class AllPlaylistsData {
  ...
  AllPlaylistsData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userid = json['userid'];
    title = json['title'];
    cover = json['cover'];
