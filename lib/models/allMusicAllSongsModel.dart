...
class AllMusicAllSongsModel {
  bool? ok;
  String? msg;
  int? count;
  int? totalStream;
  List<MusicAllSongsData>? data;

  AllMusicAllSongsModel({
    this.ok,
    this.msg,
    this.count,
    this.data,
  ...
  AllMusicAllSongsModel.fromJson({
    ...
    if (json != null) {
      ...
      count = json['count'];
      if (json['data'] != null) {
        List<MusicAllSongsData> data = <MusicAllSongsData>[];
        json['data'].forEach((v) {
          data.add(new MusicAllSongsData.fromJson(v));
        });
        this.data = <MusicAllSongsData>[];
        totalStream = 0;
        data.forEach((MusicAllSongsData d) {
          totalStream =
...
class MusicAllSongsData {
  ...
  MusicAllSongsData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userid = json['userid'];
    type = json['type'];
    title = json['title'];
