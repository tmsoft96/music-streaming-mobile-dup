...
class AllMusicModel {
  ...
  AllMusicModel.fromJson({
    ...
    if (json != null) {
      ...
      count = json['count'];
      if (json['data'] != null) {
        List<AllMusicData> data = <AllMusicData>[];
        json['data'].forEach((v) {
          data.add(new AllMusicData.fromJson(v));
        });
        this.data = <AllMusicData>[];
        totalStream = 0;
        data.forEach((AllMusicData d) {
...
class AllMusicData {
  ...
  AllMusicData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userid = json['userid'];
    type = json['type'];
    title = json['title'];
    ...
    if (json['genres'] != null) {
      ...
      for (var genre in genres!) {
        allGenresName = "$allGenresName, ${genre.genre!.name}";
      }

      if (allGenresName!.startsWith(",")) {
        allGenresName = allGenresName!.substring(1);
      }
    }
...
class Genres {
  ...
  Genres.fromJson(Map<String, dynamic> json) {
    ...
    genre =
        json['genre'] != null ? new GenreData.fromJson(json['genre']) : null;
  }
...
class GenreData {
  ...
  GenreData({this.id, this.name, this.cover, this.urlHash});
