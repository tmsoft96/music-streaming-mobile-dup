...
Widget newMusicWidget({
  @required BuildContext? context,
  @required void Function()? onSeeAll,
  @required void Function(MusicData data)? onTrackMore,
  @required void Function(MusicData data)? onMusic,
  @required void Function(MusicData data)? onPlayTrack,
  @required AllMusicNewMusicModel? model,
      ...
      Row(
        ...
        children: [
          Padding(
            ...
            child: Text("New Releases", style: h4White),
          ),
          button(
            onPressed: onSeeAll,
            text: 'More >',
