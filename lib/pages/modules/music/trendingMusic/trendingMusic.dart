...
import 'widget/trendingMusicFullWidget.dart';
import 'widget/trendingMusicWidget.dart';
...
class _TrendingMusicState extends State<TrendingMusic> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: allMusicTrendingModelStream,
      initialData: allMusicTrendingModel ?? null,
  ...
  Widget _mainContent(AllMusicTrendingModel model) {
    ...
    return widget.noOfContentDisplay == -1000
        ...
        : trendingMusicWidget(
            context: context,
            onSeeAll: () => _onSeeAll(),
            onSong: (MusicData data) => _onMusic(data, model),
            model: model,
  ...
  void _onPlayTrack(MusicData data, AllMusicTrendingModel model) {
  ...
  void _onTrackMore(MusicData data, AllMusicTrendingModel model) {
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => Scaffold(
          appBar: AppBar(title: Text("Trending Songs")),
          body: TrendingMusic(
  ...
  Map<String, dynamic> _getJson(MusicData data, AllMusicTrendingModel model) {
  ...
  void _onMusic(MusicData data, AllMusicTrendingModel model) {
